...
"x86_64-linux-4.4.0-49-generic" or
	die "Errno architecture (x86_64-linux-4.4.0-49-generic) does not match executable architecture ($Config{'archname'}-$Config{'osvers'})";
